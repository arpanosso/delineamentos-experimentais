...
description: "Disciplina ministrada aos segundos semestres de cada ano no curso de Graduação e Pós-graduação em Agronomia (Ciência do Solo e Genética e Melhoramento de Plantas) da Faculdade de Ciências Agrárias e Veterinárias (FCAV) da UNESP de Jaboticabal."
link-citations: yes
...
O Departamento de Engenharia e Ciências Exatas ([DECEx](https://www.fcav.unesp.br/#!/engenharia)), por mais de $40$ anos, tem demonstrado competência nas linhas de pesquisa em Estatística, Física, Informática, Matemática e Agrometeorologia, conferindo excelência ao campus da [Unesp – Jaboticabal](https://www.fcav.unesp.br/). 
