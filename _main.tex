...
\hypersetup{
  pdftitle={Experimentação Agrícola},
  pdfauthor={Alan R. Panosso alan.panosso@unesp.br},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Experimentação Agrícola}
\author{Alan R. Panosso \href{mailto:alan.panosso@unesp.br}{\nolinkurl{alan.panosso@unesp.br}}}
\date{2022-12-19}
...
\includegraphics[width=300px]{img/logo_22_unesp}

\hypertarget{histuxf3rico-e-justificativa}{%
\chapter{Histórico e Justificativa}\label{histuxf3rico-e-justificativa}}

O Departamento de Engenharia e Ciências Exatas (\href{https://www.fcav.unesp.br/\#!/engenharia}{DECEx}), por mais de \(40\) anos, tem demonstrado competência nas linhas de pesquisa em Estatística, Física, Informática, Matemática e Agrometeorologia, conferindo excelência ao campus da \href{https://www.fcav.unesp.br/}{Unesp -- Jaboticabal}.
...
{\centering \includegraphics[width=1000px]{img/circularidade} 

}

\caption{Circularidade do método científico.}\label{fig:unnamed-chunk-3}
\end{figure}
...
Note that the \texttt{.bib} files need to be listed \citep{ExpDes2005} in the index.Rmd with the YAML \texttt{bibliography} key.
